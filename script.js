(function () {
  ...
  // ── Deutsch: islamische Monatsnamen, kein "v. Chr." ─────────
  ...
  // ── CSV LADEN — cache: 'no-store' → immer frisch vom Server ──
  async function loadVaktijaData() {
    try {
      // Timestamp verhindert Browser-Cache, no-store verhindert Netzwerk-Cache
  ...
  function init() {
    ...
    // CSV alle 5 Minuten neu laden (statt 30) — Änderungen schneller sichtbar
